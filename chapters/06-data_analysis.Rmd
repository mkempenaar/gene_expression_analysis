# Data Analysis and Visualization {#chapter-6}

At this point we have one or more sets of DEGs from our experiment. It might be just one set or it might be a large number of comparisons made with a set of DEGs per comparison and/ or results from multiple approaches (manual, package). This chapter offers some guidance to visualize and - finally - connect some biological relevance to the results.
...
g = ggplot(data=deseq.results, 
  ...
  xlab("log2 fold change") + ylab("-log10 p-value") +
  ggtitle("DEGs according to DESeq2 with FDR <= 0.05 and absolute FC >= 1.75") +
  # Add the text labels only for DEGs. Using `ggrepel` to make sure labels don't overlap
