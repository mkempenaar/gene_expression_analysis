...
names(mdsData) <- c('x_coord', 'y_coord')
```

```{r mds_table, echo=FALSE}
pander(mdsData, caption = 'Table 4: MDS coordinates used for plotting the distances')
```

```{r mdsPlot, fig.cap="Multi Dimensional Scaling - Euclidean Distance for all samples"}
