...
## Important, Updated Instructions (13/03/2020)

Due to cancellation of all lectures for the month March; the documentation has been updated to make it easier for independent usage. The following sections have been **removed** from the manual and are now regarded fully optional. If you have done them already they will add to your grade. The listing contains a link to the chapter on a backup-site where the contents are still available. The complete previous version of this manual is available at [https://bioinf.nl/~marcelk/theme07/](https://bioinf.nl/~marcelk/theme07/). Please **do** read the parts that have been removed as they might contain information that is helpful for the remaining parts.
