...
```{r expressionHeatmap, echo=FALSE, eval=TRUE, fig.cap="Heatmap showing the fold changes of the Trisomic vs Disomic comparisons"}
# DEGs
...
pheatmap(heatmap.degs, cluster_cols = FALSE,
         ...
         main="log2(Expression) for a subset of DESeq2 DEGS with log2(FC) >= 2")
```
